  ...
  return (
    <div>
        <div className='h-full w-270'>
            <div className='w-full h-full flex justify-center items-center py-21 bg-white'>
            <img src="/src/assets/SampleItemDrop.png" alt="" />
            </div>
        </div>
        <div className=' bg-[#FFF5E3] h-full p-5 w-full'>
            <div className='flex flex-nowrap overflow-x-auto snap-x snap-mandatory w-250'>
