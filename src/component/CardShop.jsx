...
const CardShop = () => {
  ...
  return (
    <div className='w-80 m-5'>
        {/* ini image */}
      <div className='w-80 h-80 bg-gray-200  overflow-hidden' onClick={()=> navigate ("/detailproduk")} >
        <img src="/src/assets/b1.jpg" className='w-full h-full object-cover hover:transition-transform hover:scale-130 ease-in-out duration-700'/>
      </div>
      <h1 className='text-lg mt-5'>Graduation Bear</h1>
      <h1 className='font-veryvogue italic text-md'>Lorem ipsum dolor sit amet consectetur</h1>
