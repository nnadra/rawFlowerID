...
export default function DetailProduct() {
  ...
  const [liked, setLiked] = useState(false); // toggle love button
  ...
  useEffect(() => {
    axiosClient.get(`/api/products/${id}/detail`)
      .then((res) => {
        setDetailProduct(res.data.data); // sesuaikan dengan response API
      })
      .catch((err) => {
      ...
      <div className="bg-white py-10 px-6 md:px-20">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row gap-10">
          ...
          <div className="w-full md:w-1/2 space-y-5 pt-12">
            ...
            <h2 className="text-2xl font-bold text-[#4E2A1E] underline">
            ...
            <div>
              ...
              <div className="flex gap-2 mt-2 flex-wrap">
                {['Ribbon', 'Thanks Card', 'Card holder'].map((item, i) => (
                  <p
                    key={i}
                    className="px-3 py-1 rounded border text-[#4E2A1E] hover:bg-[#4E2A1E] hover:text-white"
                  >
                    {item}
                  </p>
                ))}
          ...
          <div className="w-full md:w-1/2">
            ...
            <div>
              ...
              <div className="text-sm space-y-1 text-[#4E2A1E]">
                <p>
                  <strong>Flower Type :</strong> Sunflower
                </p>
                <p>
                  <strong>Type :</strong> {detailProduct?.category || '-'}
                </p>
                <p>
                ...
                <p>
                  <strong>Additional :</strong> Ribbon, Thanks card, Card holder
                </p>
                <p>
                  <strong>Notes :</strong> Bunga bertahan 20 juta hari
                </p>
              </div>
            </div>
          </div>
