...
export default function DetailProduct() {
  ...
  const [activeImg, setActiveImg] = useState(product1); //tampilin product pertama
          ...
          <div className="w-full md:w-1/2">
            ...
            <div>
              ...
              <p className="text-sm text-gray-700 leading-relaxed mb-4">
                ...
                Vivamus dictum arcu at ultrices semper. 
                Nulla congue tempus quam, in interdum dui vestibulum ac. 
                Aliquam tincidunt nisi eu neque auctor, ac mattis mi iaculis. 
                Sed pretium a nulla non rhoncus.
              </p>
